// ============================================================
// BULLETIN GÉNÉRIQUE — Mise en page francophone standard
// ============================================================
// À la différence de BulletinTogoPDF (qui reproduit le format officiel
// togolais DRE), ce composant ne prétend représenter le format officiel
// d'aucune administration. Il sert de bulletin par défaut pour les pays
// où GestioSchool n'a pas encore de modèle officiel vérifié (ex: Congo).
// Si un format officiel est fourni, dupliquer BulletinTogoPDF plutôt que
...
export const BulletinPDF = React.forwardRef<HTMLDivElement, BulletinPDFProps>(
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 flex flex-col">
                {/* ───────────────────────────── EN-TÊTE (SCEAU | ÉTABLISSEMENT | LOGO) ───────────────────────────── */}
                <div className="mb-2">
                    <div className="flex justify-between items-center py-1 gap-2 border-b border-black pb-2">
                        <div className="flex-shrink-0 flex justify-start" style={{ width: '26mm' }}>
                            {schoolStamp ? (
                                <img src={schoolStamp} alt="Sceau" style={{ width: '24mm', height: '24mm', objectFit: 'contain' }} />
                            ) : (
                        ...
                        <div className="flex-1 flex flex-col items-center text-center space-y-1">
                            <h2 className="font-black uppercase tracking-tight text-[20px] leading-none mb-1">
                                {schoolName}
                            </h2>
                            <div className="w-16 border-t border-black my-1"></div>
                            <p className="font-bold uppercase text-[11px] tracking-widest leading-none">Bulletin Scolaire</p>
                        </div>

                        <div className="flex-shrink-0 flex justify-end" style={{ width: '26mm' }}>
                            {schoolLogo ? (
                                <img src={schoolLogo} alt="Logo" style={{ width: '24mm', height: '24mm', objectFit: 'contain' }} />
                            ) : (
                                <div className="w-[24mm] h-[24mm] flex flex-col items-center justify-center opacity-30 border border-dashed border-gray-300">
                ...
                <div className="border-[1.5px] border-black mb-1" style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 0 }}>
                    ...
                    <div className="border-l-[1.5px] border-black flex-shrink-0 relative bg-[#f8f8f8]" style={{ width: '35mm', minHeight: '35mm' }}>
                        {studentPhoto ? (
                            <img src={studentPhoto} alt="Photo élève" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
                        ) : (
                    ...
                    <div style={{ borderRight: '1.5px solid black', display: 'flex', flexDirection: 'column', flex: 1 }}>
                        <div style={{ display: 'flex', flexDirection: 'column', borderBottom: '1.5px solid black' }}>
                            ...
                            <div style={{
                                ...
                                {(() => {
                                    const isTrim = data.periode.includes('TRIMESTRE');
                                    const cycle = isTrim ? ['TRIMESTRE 1', 'TRIMESTRE 2', 'TRIMESTRE 3'] : ['SEMESTRE 1', 'SEMESTRE 2'];
